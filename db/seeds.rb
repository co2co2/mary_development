...
user1 = User.create(id:1, email:'cat@gmail.com', password:'valid_password', password_confirmation: 'valid_password')
user2 = User.create(id:2, email:'dog@gmail.com', password:'valid_password', password_confirmation: 'valid_password')

concentrate1 = user1.recipes.create(id:1, category_id:1, recommended_strain_id:nil, title:'Cannabis Coconut Oil', image:'https://s3.amazonaws.com/leafly-s3/content/cannabis-and-coconut-oil-uses-benefits-and-a-recipe-to-make-your/QqYwInfNQHedUETFu2Dm_Subhead-2.jpg', description:'coconut oil has among the highest concentration of fatty acids (saturated fats). The surplus of these fatty acids in the coconut oil create a stronger binding agent for cannabinoids. ', prep_time: 360,
...
# Rick Simpson Oil
concentrate2 = user1.recipes.create(id:2, category_id:1, recommended_strain_id:nil, title:'Rick Simpson Oil', image:nil, description:'Rick Simpson Oil, or RSO is a concentrated form of cannabis oil known to have medical benefits, particularly for cancer.', prep_time: 360,
instructions_attributes: [
